...
private:
    class Joint;
    std::vector<std::vector<Joint>> joints; // a vector of joints from base to end-effector
public:
    // void read_urdf(filepath);
    std::vector<std::vector<double>> forward_kinematics(std::vector<std::vector<double>> joint_settings) const;
    void getWS(std::vector<std::vector<double>> configs, const int nThreads) const;
...
// =================================== VERSION 1 ===========================================
// void Robot::getWS(std::vector<std::vector<double>> configs, const int nThreads) const
// {
//     /*
