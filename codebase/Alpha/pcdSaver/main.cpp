...
void pcd::drawPCD() {
  ...
  // This is the correct timing to set up a head light (a light moves with the
  // view point) >> Also the light needs to be normalized.
  ...
  // Set up model-view transformation from viewDistance, viewRotation, and
  // viewTarget
...
bool pcd::terminateStep() { return term; }
